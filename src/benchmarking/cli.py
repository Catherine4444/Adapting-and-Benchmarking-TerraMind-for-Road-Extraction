...
def run_eval(
    ...
    model: Annotated[str, typer.Option(help="Model family loader: unet | sr | terratorch")] = "unet",
    ...
    tm_data_config: Annotated[Optional[Path], typer.Option(help="Datamodule config (base_data.yml) for terratorch bands/norm")] = None,
):
    ...
    run_id = evaluate(
        ...
        buffer_px=_parse_radii(buffer_px), ap_bins=ap_bins, tm_data_config=tm_data_config,
    )
